                        ...
                        <div class="ibox-content mailbox-content">
                            <div class="file-manager clearfix">
                                ...
                                <ul class="folder-list">
                                    ...
                                    <li class="active"><a href="{{ route('admin.setting.footer.logo') }}">لوگو های فوتر</a></li>
                                </ul>
                                    ...
                                    <form>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="" style="width: 100%;">
                                                <option value="AL">لوگوی پایین فوتر</option>
                                                <option value="AL">لوگوی بالا فوتر</option>
                                            </select>
                                        </div>
